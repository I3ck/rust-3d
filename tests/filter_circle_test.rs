...
fn filter_circle_test() {
    ...
    assert!( filter.is_allowed(&*Point2D::build(7.0, -5.0)));
    assert!(!filter.is_allowed(&*Point2D::build(6.0, -5.0)));
    assert!( filter.is_allowed(&*Point2D::build(11.0, -5.0)));
    assert!( filter.is_allowed(&*Point2D::build(12.0, -5.0)));
    assert!( filter.is_allowed(&*Point2D::build(13.0, -5.0)));
    assert!(!filter.is_allowed(&*Point2D::build(14.0, -5.0)));
    ...
    assert!(!filter.is_allowed(&*Point2D::build(10.0, -1.0)));
    ...
    assert!(!filter.is_allowed(&*Point2D::build(10.0, -9.0)));
}
